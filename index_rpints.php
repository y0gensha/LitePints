	...
	if($db){
		...
		while($b = mysql_fetch_array($qry))
		{
			$beeritem = array(
				...
				"srmRgb" => $b['srmRgb'],
                                "servingSizeValue" => $b['servingSizeValue'],
                                "servingSizeUnits" => $b['servingSizeUnits'],
                                "servingContainer" => $b['servingContainer'],
								...
								<?php if($config[ConfigNames::ShowSrmCol]){ ?>
									<td class="srm">
										...
										<div class="srm-container">
                                                                                         <img height="100%" src="img/containerSvg.php?glass=<?php echo $beer['servingContainer']; ?>&rgb=<?php echo $beer['srmRgb']; ?>" />
										</div>
